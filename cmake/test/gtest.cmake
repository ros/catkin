...
if(NOT GTEST_FOUND)
  ...
  if(NOT TARGET gtest)
    ...
    if(NOT GTEST_FROM_SOURCE_FOUND)
      message(WARNING "gtest not found, C++ tests can not be built. You can run 'svn checkout http://googletest.googlecode.com/svn/tags/release-1.6.0 gtest' in the source space '${CMAKE_SOURCE_DIR}' of your workspace")
    endif()
  endif()
