...
function(catkin_install_python signature)
  ...
  cmake_parse_arguments(ARG "OPTIONAL" "DESTINATION" "CONFIGURATIONS" "" ${ARGN})
  if(NOT ARG_DESTINATION)
    message(FATAL_ERROR "catkin_install_python() called without required DESTINATION argument.")
  endif()
  if(ARG_CONFIGURATIONS)
    set(build_config CONFIGURATIONS ${ARG_CONFIGURATIONS})
  endif()
  foreach(file ${ARG_UNPARSED_ARGUMENTS})
    ...
    if(EXISTS ${file})
      ...
      install(PROGRAMS "${file}" ${build_config} DESTINATION "${ARG_DESTINATION}" ${optional_flag})
