  ...
  foreach(source_file ${ARG_UNPARSED_ARGUMENTS})
    ...
    if(EXISTS ${source_file})
      ...
      if("${shebang_line}" STREQUAL "${prefix}")
        ...
        set(installspace "${CMAKE_CURRENT_BINARY_DIR}/catkin_generated/installspace")
        file(MAKE_DIRECTORY ${installspace})
        file(COPY ${source_file} DESTINATION ${installspace} USE_SOURCE_PERMISSIONS)
        set(rewritten_file "${installspace}/${filename}")
