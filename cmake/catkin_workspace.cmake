    ...
    foreach(index RANGE ${range})
      ...
      if(${is_meta})
        ...
        if(${build_type} MATCHES catkin)
          message(STATUS "+++ processing catkin package: '${path}'")
          add_subdirectory(${path})
        endif()
        if(${build_type} MATCHES cmake)
          message(STATUS "+++ skipping plain cmake package: '${path}'")
        endif()
        if(NOT ${build_type} MATCHES catkin AND
           NOT ${build_type} MATCHES cmake)
          message(FATAL_ERROR "Unknown build type '${build_type}' for package '${path}'")
        endif()
      endif()
    endforeach()
  endif()
