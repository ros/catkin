...
function(catkin_workspace)
  ...
  if(CATKIN_ORDERED_PACKAGES)
    ...
    if(${CATKIN_NONHOMOGENEOUS_WORKSPACE})
      message(FATAL_ERROR "This workspace contains non-catkin packages in it, and catkin cannot build a non-homogeneous workspace without isolation. Try `catkin_make_isolated` command")
    endif()
