...
function(catkin_package_export)
  ...
  set(CATKIN_PACKAGE_BIN_DESTINATION lib/${PROJECT_NAME} PARENT_SCOPE)
  set(CATKIN_PACKAGE_ETC_DESTINATION etc/${PROJECT_NAME} PARENT_SCOPE)
  set(CATKIN_PACKAGE_INCLUDE_DESTINATION include/${PROJECT_NAME} PARENT_SCOPE)
  set(CATKIN_PACKAGE_LIB_DESTINATION lib PARENT_SCOPE)
  set(CATKIN_PACKAGE_PYTHON_DESTINATION ${PYTHON_INSTALL_DIR}/${PROJECT_NAME} PARENT_SCOPE)
  set(CATKIN_PACKAGE_SHARE_DESTINATION share/${PROJECT_NAME} PARENT_SCOPE)
