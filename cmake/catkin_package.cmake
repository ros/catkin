    ...
    if(${depend_name}_FOUND)
      ...
      if(NOT ${depend_name}_FOUND_CATKIN_PROJECT)
        if(DEFINED ${depend_name}_CONFIG)
          message(WARNING "catkin_package() CATKIN_DEPENDS on '${depend_name}', which has been found in '${${depend_name}_CONFIG}', but it is not a catkin package")
        else()
          message(WARNING "catkin_package() CATKIN_DEPENDS on '${depend_name}', but it is not a catkin package")
        endif()
        break()
      endif()
