...
# :param DEFINES: a list of exported preprocessor definitions, format: key[=value] 
...
function(_catkin_package)
  cmake_parse_arguments(PROJECT "SKIP_CMAKE_CONFIG_GENERATION;SKIP_PKG_CONFIG_GENERATION" "" "INCLUDE_DIRS;LIBRARIES;CATKIN_DEPENDS;DEPENDS;DEFINES;CFG_EXTRAS;EXPORTED_TARGETS" ${ARGN})
  ...
  if(NOT PROJECT_SKIP_CMAKE_CONFIG_GENERATION)
    ...
    separate_arguments(PROJECT_DEFINES)
    set(definitions "")
