function(catkin_project PACKAGE_NAME)
  ...
  if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/manifest.xml)
    ...
    message(STATUS "${project_lower} has no manifest.xml.  Not sure if this is an error or not.")
  endif()

  if (FALSE)
    # old code for how to install an autogenerated manifest.xml that thunks out to
    # pkg-config.  Delete me?
    em_expand(${catkin_EXTRAS_DIR}/templates/pkg-config.pc.context.in
      ${CMAKE_CURRENT_BINARY_DIR}/pkg-config.pc.context.py
