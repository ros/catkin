...
.. glossary::
   ...
   dry
        a package/stack/whatever not yet converted to catkin.
   ...
   GBP repository
        ...
        to assemble binary and source debs.  Bloom-controlled repositories
   ...
   wet
        a package/stack/whatever already converted to catkin.
